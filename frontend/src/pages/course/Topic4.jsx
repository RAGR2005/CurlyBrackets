...
//       {
//         lessons: [
//           { title: "Introduction to GIT", duration: "10m", completed: false },
//           { title: "Master Git Init", duration: "15m", completed: true },
//           { title: "Git commits and logs", duration: "20m", completed: true },
//           { title: "Git internal working and configs", duration: "25m", completed: false },
//           { title: "Git merge and git conflicts", duration: "30m", completed: true },
//           { title: "Git Diff and stashing", duration: "35m", completed: true },
//         ],
//       },
//     ],
//   };
...
//           <img src={banner4} alt="title" className="object-cover rounded-lg w-4xl  ml-14 h-140" />
//         </div>
//       </div>
...
function Topic4({ onBack }) {
  ...
  const handlePlayClick = (title) => {
    const videoLinks = {
      "Introduction to GIT": "https://www.youtube.com/watch?v=qol-nSNGK8o",
      "Master Git Init": "https://www.youtube.com/watch?v=NyNeBxwYohY",
      "Git internal working and configs": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "Git merge and git conflicts": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "Git Diff and stashing": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s"
    };
