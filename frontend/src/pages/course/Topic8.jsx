...
//     level: "Intermediate",
//     progress: 44,
//     tags: ["react", "reactjs", "react-basics"],
//     sections: [
//       {
        // lessons: [
        //   { title: "Components", duration: "10m", completed: false },
        //   { title: "Rendering", duration: "15m", completed: true },
        //   { title: "Props", duration: "20m", completed: true },
        //   { title: "Hooks", duration: "25m", completed: false },
        //   { title: "Routers", duration: "25m", completed: true },
        // ],
//       },
//     ],
//   };
...
//           <img src={banner8} alt="title" className="object-cover rounded-lg w-4xl  ml-14 h-140" />
//         </div>
//       </div>
...
function Topic8({ onBack }) {
  ...
  const handlePlayClick = (title) => {
    const videoLinks = {
      "Components": "https://www.youtube.com/watch?v=qol-nSNGK8o",
      "Rendering": "https://www.youtube.com/watch?v=NyNeBxwYohY",
      "Props": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "Hooks": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "Routers": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
    };
