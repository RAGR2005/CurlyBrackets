...
function Topic2({ onBack }) {
  ...
  const handlePlayClick = (title) => {
    const videoLinks = {
      "Learn the Basics": "https://www.youtube.com/watch?v=qol-nSNGK8o",
      "DOM Manipulation": "https://www.youtube.com/watch?v=NyNeBxwYohY",
      "Advanced Topics": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s"
    };
  ...
  const course = {
    ...
    sections: [
      {
        lessons: [
          { title: "Learn the Basics", duration: "10m", completed: false },
          { title: "DOM Manipulation", duration: "15m", completed: true },
          { title: "Advanced Topics", duration: "20m", completed: true },
        ],
      },
    ],
  };
      ...
      <div className="flex">
        <div className="container px-4 py-6 md:px-6 md:py-8">
          ...
          <div className="rounded-lg overflow-hidden">
            <img src={banner2} alt="title" className="object-cover rounded-lg w-4xl ml-14 h-140" />
          </div>
        </div>
