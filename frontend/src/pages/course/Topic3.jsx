...
//     level: "Intermediate",
//     progress: 40,
//     tags: ["CSS", "Frontend", "Frameworks"],
//     sections: [
//       {
//         lessons: [
//           { title: "Flexbox", duration: "10m", completed: false },
//           { title: "Grid", duration: "15m", completed: true },
//           { title: "Bootstrap", duration: "20m", completed: true },
//           { title: "Tailwind CSS", duration: "25m", completed: false },
//         ],
//       },
//     ],
//   };
...
//           <img src={banner3} alt="title" className="object-cover rounded-lg w-4xl  ml-14 h-140" />
//         </div>
//       </div>
...
function Topic3({ onBack }) {
  ...
  const handlePlayClick = (title) => {
    const videoLinks = {
      "Flexbox": "https://www.youtube.com/watch?v=qol-nSNGK8o",
      "Grid": "https://www.youtube.com/watch?v=NyNeBxwYohY",
      "Bootstrap": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "Tailwind CSS": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s"
    };
    ...
    sections: [
      {
        lessons: [
          ...
          { title: "Grid", duration: "15m", completed: true },
          { title: "Bootstrap", duration: "20m", completed: true },
          { title: "Tailwind CSS", duration: "20m", completed: true },
        ],
      },
    ],
  };
