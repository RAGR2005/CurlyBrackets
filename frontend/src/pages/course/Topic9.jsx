...
//     level: "Advanced",
//     progress: 61,
//     tags: ["state", "props", "react-components"],
//     sections: [
//       {
        // lessons: [
        //   { title: "React 101", duration: "10m", completed: false },
        //   { title: "Getting Started with React", duration: "15m", completed: true },
        //   { title: "React Basics", duration: "20m", completed: true },
        //   { title: "Building Your First App with React", duration: "25m", completed: false },
        //   { title: "React for Absolute Beginners", duration: "30m", completed: true },
        // ],
//       },
//     ],
//   };
...
//           <img src={banner9} alt="title" className="object-cover rounded-lg w-4xl  ml-14 h-140" />
//         </div>
//       </div>
...
function Topic9({ onBack }) {
  ...
  const handlePlayClick = (title) => {
    const videoLinks = {
      "React 101": "https://www.youtube.com/watch?v=qol-nSNGK8o",
      "Getting Started with React": "https://www.youtube.com/watch?v=NyNeBxwYohY",
      "React Basics": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "Building Your First App with React": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "React for Absolute Beginners": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
    };
