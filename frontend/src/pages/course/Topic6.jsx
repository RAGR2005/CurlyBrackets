...
//     level: "Advanced",
//     progress: 38,
//     tags: ["BackendDevelopment", "AdvancedBackend", "ServerArchitecture"],
//     sections: [
//       {
        // lessons: [
        //   { title: "Creating First Server with Express", duration: "10m", completed: false },
        //   { title: "HTTP Requests", duration: "15m", completed: true },
        //   { title: "Postman", duration: "20m", completed: true },
        //   { title: "Middlewares", duration: "25m", completed: false },
        //   { title: "REST API", duration: "30m", completed: true },
        //   { title: "GraphQL API", duration: "35m", completed: false },
        // ],
//       },
//     ],
//   };
...
//           <img src={banner6} alt="title" className="object-cover rounded-lg w-4xl  ml-14 h-140" />
//         </div>
//       </div>
...
function Topic6({ onBack }) {
  ...
  const handlePlayClick = (title) => {
    const videoLinks = {
      "Creating First Server with Express": "https://www.youtube.com/watch?v=qol-nSNGK8o",
      "HTTP Requests": "https://www.youtube.com/watch?v=NyNeBxwYohY",
      "Postman": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "Middlewares": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "REST API": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "GraphQL API": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s"
    };
