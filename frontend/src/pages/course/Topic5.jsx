...
//       {
//         lessons: [
//           { title: "Overview", duration: "10m", completed: false },
//           { title: "Backend Tools and Techniques", duration: "15m", completed: true },
//           { title: "Node.js", duration: "20m", completed: true },
//           { title: "Express", duration: "25m", completed: false },
//         ],
//       },
//     ],
//   };
...
//           <img src={banner5} alt="title" className="object-cover rounded-lg w-4xl  ml-14 h-140" />
//         </div>
//       </div>
...
function Topic5({ onBack }) {
  ...
  const handlePlayClick = (title) => {
    const videoLinks = {
      "Overview": "https://www.youtube.com/watch?v=qol-nSNGK8o",
      "Backend Tools and Techniques": "https://www.youtube.com/watch?v=NyNeBxwYohY",
      "Node.js": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s",
      "Express": "https://www.youtube.com/watch?v=q15h4RXBTcI&t=162s"
    };
